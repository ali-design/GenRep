    ...
    def __init__(
        ...
        super().__init__(OrderedDict([
            ...
            ('dconv', DemodulatedConv2dF(in_channel, out_channel, kernel_size,
                demodulate=demodulate, upsample=upsample, return_as=return_as)),
        ] + blur_step))

class DemodulatedConv2dF(nn.Module):
    def __init__(self, in_channel, out_channel, kernel_size,
            demodulate=True, upsample=False, return_as='fmap'):
        super().__init__()
        self.kernel_size = kernel_size
        self.in_channel = in_channel
        self.out_channel = out_channel
...
class ToRGBF(nn.Module):
    def __init__(self, in_channel, style_dim,
        ...
        self.conv = MConv(in_channel, 3, 1, style_dim,
                demodulate=False, return_as='output')
