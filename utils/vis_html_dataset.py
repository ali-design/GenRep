...
#         imgList_filename = join(home_dir, 'ratiodata0.1_imgList.txt')
        ...
        with open('./imagenet_class_name.json', 'rb') as fid:
...
make_html('/data/vision/phillipi/ganclr/datasets/biggan-deep-256_tr2.0_gauss1_std0.5_imagenet1000_NS1300_NN1')
