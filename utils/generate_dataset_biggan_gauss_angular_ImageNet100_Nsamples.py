...
if __name__ == '__main__':
    ...
    parser.add_argument('--desc', default='rnd_gauss_angular-std1.0_100', type=str, help='this will be the tag of this specfic dataset, added to the end of the dataset name')
