...
--ckpt /data/scratch-oc40/jahanian/ganclr_results/SupCon/biggan_models/SupCon_biggan_ganzoomwalk_resnet50_lr_0.03_decay_0.0001_bsz_256_temp_0.1_trial_0_biggan256tr1-png_steer_composite2-trunc1-lr001-origTF_100_cosine/last.pth \
--data_folder /data/scratch-oc40/jahanian/ganclr_results/ImageNet100/ --learning_rate 2 --batch_size 128
