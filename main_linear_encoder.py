...
def set_model(opt):
    ...
    pretrained_dict['stem.1.running_mean'] = pretrained_dict['bn1.running_mean']
    pretrained_dict['stem.1.running_var'] = pretrained_dict['bn1.running_var']
    pretrained_dict['stem.1.num_batches_tracked'] = pretrained_dict['bn1.num_batches_tracked']
