...
def parse_option():
    ...
    for model in ['resnet50v1', 'resnet50v2', 'resnet50v3']:
        if model in opt.model_path:
            opt.model = model
            break
...
def main():
    ...
    # encoder
    model = MyResNetsCMC(args.model, set_dp=True)
    ...
    test_feat = model(test_data, is_feat=True)
